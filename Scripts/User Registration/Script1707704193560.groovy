...
WebUI.setText(findTestObject('Object Repository/Page_Advantage Shopping/input__usernameRegisterPage'), 'advantageuser1')

WebUI.setText(findTestObject('Object Repository/Page_Advantage Shopping/input__emailRegisterPage'), 'advantageuser1@user.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Advantage Shopping/input__passwordRegisterPage'), 'p4y+y39Ir5OTdtOb306gDg==')
